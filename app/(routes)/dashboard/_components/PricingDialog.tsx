...
function PricingDialog() {
  ...
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
    ...
    >
      ...
      <Link
        href=""//link
        className="mt-8 block rounded-full border border-primary/100
         bg-primary/80 px-12 py-3 text-center text-sm font-medium text-white hover:bg-primary hover:ring-1 hover:ring-primary/100 focus:outline-none focus:ring active:text-primary"
      >
        Upgrade
      </Link>
    </div>
